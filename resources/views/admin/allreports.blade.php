		...
		<section id="main-content">
			<section class="wrapper site-min-height">
				...
				<div class="col-lg-9 ds" style="">
					...
					<a href="{{ url('adminviewdepartment')."/".$department->d_id}}"><div class="col-md-4 col-sm-4 mb" style="margin-top: 20px;">
            ...
            <a href="{{ url('adminviewsubdepartment')."/".$managers->sd_id}}"><div class="col-md-4 col-sm-4 mb" style="margin-top: 20px;">
                    <div class="darkblue-panel pn">
                        <div class="darkblue-header" style="padding-top: 50px;">
                            <h5>{{$managers->sd_title}}</h5>
                        </div>
                        <canvas id="serverstatus02" height="10" width="120"></canvas>
                        <button class="btn btn-xs btn-block" style="padding: 5px; margin-top: 20px;">View {{$managers->sd_title}}</button>
                        <footer style="background-color: blue">
                            <div class="pull-left">
                            </div>
                            <div class="pull-right">
