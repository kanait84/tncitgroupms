	...
	<section id="container">
		...
		<section id="main-content">
			<section class="wrapper">
				<h3><i class="fa fa-angle-right"></i> Add Sub Department</h3>
				<!-- BASIC FORM ELELEMNTS -->
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">

							<form class="form-horizontal style-form" method="post" action="postsubdepartment" enctype="multipart/form-data" autocomplete="off" style="margin-left: 20px; padding-top: 20px; padding-bottom: 20px;">
								{{ csrf_field() }}

								<div class="form-group">
									<label class="control-label col-md-2">Head Department</label>
								...
								<div class="form-group">
									...
									<div class="col-md-3 col-xs-11">
										<input class="form-control form-control-inline" type="text" value="" name="sd_title" id="sd_title" required="">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="sd_description" id="sd_description" placeholder="Sub-Department details" rows="5" data-rule="required" data-msg="Please write your daily report"></textarea>
										<span class="help-block"></span>
