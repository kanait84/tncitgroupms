    ...
    <div class="row">
        <div class="col-md-12">
            <div class="p-bck" style="white-space: pre-line">
                ...
                <p><a class="btn btn-success btn-xs" href="/otMgrApprovedreq/{{ $n_id.'/'.$r_date.'/'.$u_id.'/'.$otdetail[0]->report_uid}}">
                        <i class="fa fa-thumbs-up"></i> Approve</a> &nbsp; <a class="btn btn-danger btn-xs" href="/otMgrDisapprovedreq/{{$n_id.'/'.$r_date.'/'.$u_id.'/'.$mgr_id}}">
