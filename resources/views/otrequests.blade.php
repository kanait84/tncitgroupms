...
<section id="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <h3 style="display: inline;font-size: 18px;">Month :</h3>
            <?php
            $MonthVal = date('F');
            $MonthNumber = date('n');
            $YearNumber = date('Y');
            ...
            <select name="monthfilter" id="monthfilter" class="btn btn-primary form-control" style="width: auto">
                <?php
                $j = 1;
                foreach($months as $key =>$value){ ?>
                <option value="{{$key}}" <?php if($key==$monthval){ echo "selected='selected'"; } ?>>{{$value." ".$YearNumber}}</option>
                <?php
                $j++;
                } ?>
            </select>

            <h3 style="display: inline;margin-top: 5px;margin-left: 50px;font-size: 18px;">
                Total: {{$AllcountHrs."hrs ".$AllcountMins."mins"}}</h3>
            <a href="otselectrequests" class="btn btn-primary" style="margin-left: 50px;">
                <i class="fa fa-print" aria-hidden="true"></i> Print</a>
            <a class="btn pull-right" href="overtimerequest">
                <i class="fa fa-plus-circle" aria-hidden="true" style="font-size: 4.5rem;margin-top: -10px"></i></a>


        </div>
        <div class="col-md-6">
            <div class="form-group">
                <h3 class="control-label col-md-2"> </h3>
                <div class="col-md-4 col-xs-6">
                    <h3 class="control-label text-left"></h3>
                </div>
            </div>
        </div>
        </div>
...
<script>
    $("#monthfilter").on("change", function (e) {
        ...
        window.location.href = window.location.origin + '/otrequests?m=' + edit_id;
    });
</script>
