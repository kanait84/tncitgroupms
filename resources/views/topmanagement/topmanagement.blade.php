...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <div class="row">
            ...
            <a href="{{ url('viewdepartment')."/".$department->d_id}}">
                <div class="col-md-4 col-sm-4 mb" style="margin-top: 20px;">
        ...
        @endforeach
            <a href="{{ url('viewsubdepartment')."/".$managers->sd_id}}"><div class="col-md-4 col-sm-4 mb" style="margin-top: 20px;">
            <div class="darkblue-panel pn">
                <div class="darkblue-header" style="padding-top: 50px;">
