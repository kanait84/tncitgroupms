    ...
    <div class="row">
        <div class="col-md-12">
            <div class="p-bck" style="white-space: pre-line">
                ...
                <p><b>Approved Department Manager: &nbsp; {{$mgrname}}</b></p>
                <p><b>Approved by Reporting Koran Manager: &nbsp; {{$reportusername}}</b></p>
                <p><b>Reason:</b> &nbsp; <name>{{$otdetail[0]->reason}}</name></p>
                <p> <a class="btn btn-success btn-xs" href="/otHRApprovedreq/{{ $n_id.'/'.$r_date.'/'.$u_id.'/'.$otdetail[0]->report_uid}}">
                <i class="fa fa-thumbs-up"></i> Approve</a> &nbsp;&nbsp;<a class="btn btn-danger btn-xs" href="/otHRDisapprovedreq/{{$n_id.'/'.$r_date.'/'.$u_id.'/'.$otdetail[0]->report_uid}}">
