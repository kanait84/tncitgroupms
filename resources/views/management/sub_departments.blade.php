		...
		<section id="main-content">
			<section class="wrapper site-min-height">
				...
				<div class="row mt">
					<div class="col-lg-8">
				<?php
					if(isset($d_id) && $d_id=='marketing_seo'){
						$sub_department = 'SEO';
					} elseif($d_id=='it_app'){
						$sub_department = 'APP';
					} elseif($d_id=='marketing_content'){
						$sub_department = 'Content';
					} elseif($d_id=='marketing_support'){
						$sub_department = 'Support';
					} elseif($d_id=='it_blockchain'){
						$sub_department = 'Blockchain';
					} elseif($d_id=='management_operation'){
						$sub_department = 'Operation';
					}
				?>

						<h3><i class="fa fa-angle-right"></i>  {{$sub_department}} Team</h3>

						 <div class="row" style="margin-top: 20px;">
					 
								@forelse($staffs as $report)
								...
								<div class="col-lg-3 col-md-3 col-sm-3 mb">
									...
									<div class="profile-pic">
										<div class="user">
										<p>
											<img src="/photo_storage/{{$report->email}}-{{$report->name}}.jpg" class="img-circle" align="centered"></p>
											<p></p>
										</div>
										</div>
										<div class="pr2-social centered">
										<a href="/viewemployee/{{$report->id}}" class="btn btn-sm btn-clear-g" style="margin-top: 10px; color: #3d3d3d;">View Report</a>
									</div>
									</div>
								</div>
